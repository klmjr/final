...
public class TestFinance {
	...
	public void TestPV() {
		...
		double PV = Retirement.TotalAmountToSave(dAnnualReturnRetired / 12, iYearsRetired * 12, dRequiredIncome - dMonthlySSI, 0, false);
	...
	public void TestPMT() {
		...
		double PMT = Retirement.MonthlySavings(iYearsToWork, dAnnualReturnWorking, iYearsRetired, dAnnualReturnRetired, dRequiredIncome, dMonthlySSI, false);
